...
#    print(old[scaffold][partstart].new_name, lengths[old[scaffold][partstart].new_name])
...
#    print("{}\t{}\t{}".format(scaffold, partstart, part))
#    print("\t{}".format(gap))
#    print("\t{}\t{}\t{}\t{}".format(new_gap_start, new_gap_end, new_end, offset))
...
#    print("\t\t{}\t{}\t{}".format(scaffold, old_start, old[scaffold][old_start]))
...
#    print("\t\t{}\t{}\t{}".format(gap.new_name, gap.new_start, old[gap.new_name][gap.new_start]))
...
#    print("\t\t{}\t{}\t{}".format(scaffold, gap.old_start, old[scaffold][gap.old_start]))
